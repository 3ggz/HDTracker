...
const EXTRACTION_PROMPT = [
  ...
  "",
  "DOOR NOTES — RARELY USED; SENSITIVE CLINICAL AREAS ONLY:",
  "The 'notes' field must be null for the VAST majority of doors. Only write a note when the door clearly opens into (or sits inside) a SENSITIVE CLINICAL AREA where the installer needs to know to take extra care. Otherwise leave it null — the tech can navigate by sight.",
  "ONLY these kinds of areas warrant a note (write them as the area name, short):",
  "  - 'OR' / 'Operating Room'",
  "  - 'NICU'",
  "  - 'ICU'",
  "  - 'L&D' / 'LDR' / 'LDRP' (labor & delivery)",
  "  - 'PACU' / 'Post-Anesthesia'",
  "  - 'Cath Lab'",
  "  - 'ED' / 'ER' / 'Emergency'",
  "  - 'Isolation Room' or other tagged sterile/infectious area",
  "DO NOT write notes for any of the following — they are NOISE and the user does NOT want them:",
  "  - bathrooms / toilets, corridors, stairwells, elevators, equipment rooms, supply rooms, clean utility, soiled utility, holding, exam rooms, normal patient rooms, nurse stations, waiting rooms, offices, lounges, pantries, lockers",
  "  - 'near data closet', 'corridor by X', 'between X and Y' — navigation noise, never useful",
  "  - any equipment / wiring narration",
  "If you are unsure whether an area is 'sensitive enough', leave the note null. The bar is high: ask 'does the installer need to know this is a sensitive zone before they walk in?' If no, null.",
  "",
  "ITEMS — VARY PER DOOR; DO NOT BLANKET-ASSIGN:",
  "For each door, list ONLY the equipment whose dot is visible on the map AND wired to that door's 5500. Use only these exact strings: '5500 Exciter', '5200 Exciter', '3220 Exciter', '4210 Antenna', 'Strobe'.",
