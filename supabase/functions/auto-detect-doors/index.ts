...
const EXTRACTION_PROMPT = [
  ...
  "",
  "DOOR NOTES — KEEP EMPTY UNLESS THERE'S NON-IMPLIED INFO:",
  "The 'notes' field on each door must be null in almost every case. Do NOT describe the equipment or the wiring chain — the tech reading this app already knows the legend and the device colors. Examples of notes that are USELESS and must NOT be written: 'magenta dot with strobe', 'green 5200 paired on chain', 'has 5500 controller and 4210 antenna', 'standard HUGS install'. Only set notes to a short string if the MAP shows something genuinely distinctive that the tech wouldn't already know from the equipment list — e.g. 'near data closet', 'requires backboard', 'shared wall with construction zone'. If in doubt, leave notes null.",
  "",
  "ITEMS:",
