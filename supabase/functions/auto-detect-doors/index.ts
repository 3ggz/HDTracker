...
const EXTRACTION_PROMPT = [
  ...
  "",
  "DOOR NOTES — ONLY ROOM/AREA CONTEXT, NOTHING ELSE:",
  "The 'notes' field should be a SHORT (2–6 word) location/area designator IF the map shows a room label or area name near the door. The goal is to help a tech navigate to the door. Read room labels printed on the floor plan (LDRP, NICU, OR, ICU, ED, C-SECTION, HOLDING, NURSERY, CORRIDOR, STAIR, etc.) and write the relevant one as the note.",
  "GOOD examples (write these): 'in OR', 'in NICU', 'in LDRP', 'near C-section room', 'stairwell entry', 'NICU corridor', 'mother-baby unit'.",
  "USELESS examples — NEVER write these:",
  "  - equipment narration ('magenta dot with strobe', 'has 5500 + 4210', 'green 5200 paired on chain')",
  "  - generic boilerplate ('standard HUGS install', 'protected egress', 'controller-led door')",
  "  - redundant with the door label ('E5 elevator door' when label is already E5)",
  "  - color/chain talk of any kind (the tech knows how the map works)",
  "If the map shows no clear room context near the door, leave notes null. Do not invent context that isn't printed on the map.",
  "",
  "ITEMS:",
