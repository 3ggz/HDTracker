...
// Lightweight IP / MAC sheet — one clean table, nothing else. Meant
// for handing to network admins: Door, IP, MAC (plus a Device column
// only when a door carries more than one networked item).
  ...
  return (
    <>
      ...
      <header className="netlist-toolbar sticky top-0 z-10 flex items-center gap-3 border-b border-neutral-200 bg-neutral-50/80 px-4 py-3 backdrop-blur dark:border-neutral-800 dark:bg-neutral-950/80">
        ...
        <ExportPdfButton
          documentTitle={`${typedJob.name} IP-MAC list`}
        />
      </header>
