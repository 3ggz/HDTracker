...
const textareaClass =
  "block min-h-[140px] w-full rounded-xl border border-neutral-300 bg-white px-4 py-3 text-base text-neutral-900 outline-none transition focus:border-neutral-900 focus:ring-2 focus:ring-neutral-900/10 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-50 dark:focus:border-neutral-100 dark:focus:ring-neutral-100/10";
...
export default function AskQuestionPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (!title) {
      setError("Give it a title — a one-line question works best.");
      return;
    }
    ...
    if (dbError || !data) {
      setError(dbError?.message ?? "Couldn't post. Try again.");
      setPending(false);
      return;
    }

    router.push(`/faq/q/${data.id}`);
    router.refresh();
  }
    ...
    <>
      ...
      >
        ...
        <p className="text-xs text-neutral-500 dark:text-neutral-400">
          Photos can be added on the question page after posting.
        </p>
